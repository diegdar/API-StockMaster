...
class FifoValuation implements InventoryValuationStrategy
{
    /**
     * Calculate the total valuation of a product using the FIFO method.
     */
    ...
    /**
     * Get all IN stock movements for a product, ordered by creation date (FIFO).
     */
    ...
    /**
     * Core FIFO valuation logic: calculates the value of remaining stock.
     */
