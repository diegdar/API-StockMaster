...
class WarehouseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Slug will be auto-generated by WarehouseObserver
        Warehouse::create([
            'name' => 'Almacén Central (Madrid)',
            'location' => 'Polígono Industrial Vallecas, Calle Principal 100, Madrid',
            'capacity' => 50000,
            'is_active' => true,
        ]);
        Warehouse::create([
            'name' => 'Almacén Norte (Bilbao)',
            'location' => 'Zona Portuaria Bilbao, Muelle 15, Bilbao',
            'capacity' => 35000,
            'is_active' => true,
        ]);
        Warehouse::create([
            'name' => 'Almacén Sur (Sevilla)',
            'location' => 'Parque Logístico Sevilla, Nave 8, Sevilla',
            'capacity' => 40000,
            'is_active' => true,
        ]);
